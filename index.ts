...
import { GoogleProvider } from "@/sites/google";
import { GmailProvider } from "@/sites/google.gmail";
import { GoogleDocsProvider } from "@/sites/google.docs";
import { GooglePlayProvider } from "@/sites/google.play";
import { YoutubeProvider } from "@/sites/google.youtube";
import { SoGouProvider } from "@/sites/sogou";
import { BaiduProvider } from "@/sites/baidu";
import { BaiduVideoProvider } from "@/sites/baidu.video";
import { BaiduXueshuProvider } from "@/sites/baidu.xueshu";
import { TiebaProvider } from "@/sites/baidu.tieba";
import { ZhihuProvider } from "@/sites/zhihu";
import { ZhihuZhuanlanProvider } from "@/sites/zhihu.zhuanlan";
import { ZhihuDailyProvider } from "@/sites/zhihu.daily";
import { SoProvider } from "@/sites/so";
import { WeboProvider } from "@/sites/weibo";
import { TwitterProvider } from "@/sites/twitter";
import { JuejinProvider } from "@/sites/juejin";
import { QQMailProvider } from "@/sites/qq.mail";
import { MozillaProvider } from "@/sites/mozilla";
import { JianShuProvider } from "@/sites/jianshu";
import { DouBanProvider } from "@/sites/douban";
import { PocketProvider } from "@/sites/pocket";
import { DogeDogeProvider } from "@/sites/dogedoge";
import { RuyoProvider } from "@/sites/ruyo";
import { SteamProvider } from "@/sites/steam";
